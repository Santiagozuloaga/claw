...
Slash commands in REPL:
  ...
  /mcp remove <n>   Remove an MCP server from CLAW_2026_06_24_CONFIG_V01
...
def cmd_model(args: str, _state, config) -> bool:
    from CLAW_2026_06_24_PROVIDERS_V01 import PROVIDERS, detect_provider
    if not args:
        model = config["model"]
        ...
        from CLAW_2026_06_24_CONFIG_V01 import save_config
        save_config(config)
    return True
...
def _generate_personas(topic: str, curr_model: str, config: dict, count: int = 5) -> dict | None:
    ...
    from CLAW_2026_06_24_PROVIDERS_V01 import stream, TextChunk
    import json
...
def _interactive_ollama_picker(config: dict) -> bool:
    ...
    from CLAW_2026_06_24_PROVIDERS_V01 import PROVIDERS, list_ollama_models
...
def cmd_brainstorm(args: str, state, config) -> bool:
    ...
    """
    from CLAW_2026_06_24_PROVIDERS_V01 import stream
    import time
    from pathlib import Path
...
"""
        ...
        try:
            from CLAW_2026_06_24_PROVIDERS_V01 import TextChunk
...
def cmd_save(args: str, state, _config) -> bool:
    from CLAW_2026_06_24_CONFIG_V01 import SESSIONS_DIR
    import uuid
...
def save_latest(args: str, state, config_or_none=None) -> bool:
    ...
    from CLAW_2026_06_24_CONFIG_V01 import MR_SESSION_DIR, DAILY_DIR, SESSION_HIST_FILE
...
def cmd_load(args: str, state, _config) -> bool:
    from CLAW_2026_06_24_CONFIG_V01 import SESSIONS_DIR, MR_SESSION_DIR, DAILY_DIR
    ...
    if not args.strip():
        ...
        from CLAW_2026_06_24_CONFIG_V01 import SESSION_HIST_FILE
...
def cmd_resume(args: str, state, _config) -> bool:
    from CLAW_2026_06_24_CONFIG_V01 import MR_SESSION_DIR
...
def cmd_cost(_args: str, state, config) -> bool:
    from CLAW_2026_06_24_CONFIG_V01 import calc_cost
...
def cmd_cloudsave(args: str, state, config) -> bool:
    ...
    /cloudsave load <gist_id>  — download and load a session from Gist
    """
    from CLAW_2026_06_24_CLOUDSAVE_V01 import validate_token, upload_session, list_sessions, download_session
    from CLAW_2026_06_24_CONFIG_V01 import save_config
...
def cmd_exit(_args: str, _state, _config) -> bool:
    ...
    if _config.get("cloudsave_auto") and _config.get("gist_token") and _state.messages:
        ...
        from CLAW_2026_06_24_CLOUDSAVE_V01 import upload_session
        from CLAW_2026_06_24_CONFIG_V01 import save_config
...
def cmd_memory(args: str, _state, _config) -> bool:
    from CLAW_2026_06_24_MEMORY_SHIM_V01 import search_memory, load_index
    from CLAW_2026_06_24_MEMORY_PACKAGE_V01.scan import scan_all_memories, format_memory_manifest, memory_freshness_text

    stripped = args.strip()

    # /memory consolidate  — extract long-term memories from current session
    if stripped == "consolidate":
        from CLAW_2026_06_24_MEMORY_SHIM_V01 import consolidate_session
...
def cmd_agents(_args: str, _state, _config) -> bool:
    try:
        from CLAW_2026_06_24_MULTI_AGENT_V01.tools import get_agent_manager
...
def cmd_skills(_args: str, _state, _config) -> bool:
    from CLAW_2026_06_24_SKILL_V01 import load_skills
    skills = load_skills()
    if not skills:
...
def cmd_mcp(args: str, _state, _config) -> bool:
    ...
    """
    from CLAW_2026_06_24_MCP_V01.client import get_mcp_manager
    from CLAW_2026_06_24_MCP_V01.config import (load_mcp_configs, add_server_to_user_config,
                             remove_server_from_user_config, list_config_files)
    from CLAW_2026_06_24_MCP_V01.tools import initialize_mcp, reload_mcp, refresh_server
...
def cmd_plugin(args: str, _state, _config) -> bool:
    ...
    """
    from CLAW_2026_06_24_PLUGIN_V01 import (
    ...
    if subcmd == "recommend":
        ...
        if not context:
            ...
            from CLAW_2026_06_24_PLUGIN_V01.recommend import recommend_from_files
...
def cmd_tasks(args: str, _state, _config) -> bool:
    ...
    /tasks clear            — delete all tasks
    """
    from CLAW_2026_06_24_TASK_V01 import list_tasks, get_task, create_task, update_task, delete_task, clear_all_tasks
    from CLAW_2026_06_24_TASK_V01.types import TaskStatus
...
def cmd_voice(args: str, state, config) -> bool:
    ...
    if subcmd == "status":
        try:
            from CLAW_2026_06_24_VOICE_V01 import check_voice_deps, check_recording_availability, check_stt_availability
            from CLAW_2026_06_24_VOICE_V01.stt import get_stt_backend_name
    ...
    try:
        from CLAW_2026_06_24_VOICE_V01 import check_voice_deps, voice_input as _voice_input
    except ImportError:
...
def handle_slash(line: str, state, config) -> Union[bool, tuple]:
    ...
    from CLAW_2026_06_24_SKILL_V01 import find_skill
...
def repl(config: dict, initial_prompt: str = None):
    from CLAW_2026_06_24_CONFIG_V01 import HISTORY_FILE
    from CLAW_2026_06_24_CONTEXT_V01 import build_system_prompt
    from CLAW_2026_06_24_AGENT_V01 import AgentState, run, TextChunk, ThinkingChunk, ToolStart, ToolEnd, TurnDone, PermissionRequest
    ...
    if not initial_prompt:
        from CLAW_2026_06_24_PROVIDERS_V01 import detect_provider
        model    = config["model"]
        pname    = detect_provider(model)
    ...
    def run_query(user_input: str, is_background: bool = False):
        ...
        from CLAW_2026_06_24_TOOLS_V01 import drain_pending_questions
    ...
    while True:
        ...
        while isinstance(result, tuple):
            ...
            try:
                from CLAW_2026_06_24_SKILL_V01 import substitute_arguments
...
def main():
    ...
    from CLAW_2026_06_24_CONFIG_V01 import load_config, save_config, has_api_key
    from CLAW_2026_06_24_PROVIDERS_V01 import detect_provider, PROVIDERS
    ...
    if args.model:
        ...
        if "/" not in m and ":" in m:
            from CLAW_2026_06_24_PROVIDERS_V01 import PROVIDERS
            left, _ = m.split(":", 1)
            if left in PROVIDERS:
                m = m.replace(":", "/", 1)
        config["model"] = m
