...
import importlib; _m_recorder = importlib.import_module(".2024-06-19_CLAW_RECORDER_V01", __package__); globals().update({'SAMPLE_RATE': getattr(_m_recorder, 'SAMPLE_RATE'), 'CHANNELS': getattr(_m_recorder, 'CHANNELS'), 'BYTES_PER_SAMPLE': getattr(_m_recorder, 'BYTES_PER_SAMPLE')})
