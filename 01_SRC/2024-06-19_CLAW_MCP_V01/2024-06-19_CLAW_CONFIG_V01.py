...
import importlib; _m_types = importlib.import_module(".2024-06-19_CLAW_TYPES_V01", __package__); globals().update({'MCPServerConfig': getattr(_m_types, 'MCPServerConfig')})
