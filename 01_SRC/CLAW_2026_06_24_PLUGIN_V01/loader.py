...
from CLAW_2026_06_24_PLUGIN_V01.store import list_plugins
from CLAW_2026_06_24_PLUGIN_V01.types import PluginEntry, PluginScope
...
def register_plugin_tools(scope: PluginScope | None = None) -> int:
    ...
    """
    from CLAW_2026_06_24_TOOL_REGISTRY_V01 import register_tool, ToolDef
    count = 0
    for entry in load_all_plugins(scope):
        if not entry.manifest or not entry.manifest.tools:
            continue
