...
import importlib; _m_subagent = importlib.import_module(".2024-06-19_CLAW_SUBAGENT_V01", __package__); globals().update({'SubAgentManager': getattr(_m_subagent, 'SubAgentManager'), 'get_agent_definition': getattr(_m_subagent, 'get_agent_definition'), 'load_agent_definitions': getattr(_m_subagent, 'load_agent_definitions')})
