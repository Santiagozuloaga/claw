...
def cmd_memory(args: str, _state, _config) -> bool:
    from CLAW_2026_06_24_MEMORY_PACKAGE_V01 import search_memory, load_index
    ...
    if stripped == "consolidate":
        from CLAW_2026_06_24_MEMORY_PACKAGE_V01 import consolidate_session
...
def repl(config: dict, initial_prompt: str = None):
    ...
    from CLAW_2026_06_24_CONTEXT_V01 import build_system_prompt as _build_system_prompt_orig
