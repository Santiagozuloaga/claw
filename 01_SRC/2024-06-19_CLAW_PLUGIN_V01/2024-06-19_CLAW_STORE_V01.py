...
import importlib; _m_types = importlib.import_module(".2024-06-19_CLAW_TYPES_V01", __package__); globals().update({'PluginEntry': getattr(_m_types, 'PluginEntry'), 'PluginManifest': getattr(_m_types, 'PluginManifest'), 'PluginScope': getattr(_m_types, 'PluginScope'), 'parse_plugin_identifier': getattr(_m_types, 'parse_plugin_identifier'), 'sanitize_plugin_name': getattr(_m_types, 'sanitize_plugin_name')})
