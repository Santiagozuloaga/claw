...
globals().update({'estimate_tokens': getattr(m_2024_06_19_CLAW_COMPACTION_V01, 'estimate_tokens'), 'get_context_limit': getattr(m_2024_06_19_CLAW_COMPACTION_V01, 'get_context_limit'), 'snip_old_tool_results': getattr(m_2024_06_19_CLAW_COMPACTION_V01, 'snip_old_tool_results'), 'find_split_point': getattr(m_2024_06_19_CLAW_COMPACTION_V01, 'find_split_point')})
