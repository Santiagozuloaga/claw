...
class TestSplitIdentifier:
    def test_camel_case(self):
        import importlib; _mod = importlib.import_module('2024-06-19_CLAW_VOICE_V01.keyterms'); globals().update({k: getattr(_mod, k) for k in ['split_identifier']})
...
class TestGetVoiceKeyterms:
    def test_returns_list(self):
        import importlib; _mod = importlib.import_module('2024-06-19_CLAW_VOICE_V01.keyterms'); globals().update({k: getattr(_mod, k) for k in ['get_voice_keyterms']})
        terms = get_voice_keyterms()
        assert isinstance(terms, list)

    def test_global_terms_present(self):
        import importlib; _mod = importlib.import_module('2024-06-19_CLAW_VOICE_V01.keyterms'); globals().update({k: getattr(_mod, k) for k in ['get_voice_keyterms', 'GLOBAL_KEYTERMS']})
        terms = get_voice_keyterms()
    ...
    def test_max_length(self):
        import importlib; _mod = importlib.import_module('2024-06-19_CLAW_VOICE_V01.keyterms'); globals().update({k: getattr(_mod, k) for k in ['get_voice_keyterms', 'MAX_KEYTERMS']})
        terms = get_voice_keyterms()
...
class TestPcmToWav:
    def test_riff_header(self):
        import importlib; _mod = importlib.import_module('2024-06-19_CLAW_VOICE_V01.stt'); globals().update({k: getattr(_mod, k) for k in ['_pcm_to_wav']})
...
class TestKeytermsToPrompt:
    def test_empty(self):
        import importlib; _mod = importlib.import_module('2024-06-19_CLAW_VOICE_V01.stt'); globals().update({k: getattr(_mod, k) for k in ['_keyterms_to_prompt']})
...
class TestSttAvailability:
    def test_returns_tuple(self):
        import importlib; _mod = importlib.import_module('2024-06-19_CLAW_VOICE_V01.stt'); globals().update({k: getattr(_mod, k) for k in ['check_stt_availability']})
...
class TestRecorderAvailability:
    def test_returns_tuple(self):
        import importlib; _mod = importlib.import_module('2024-06-19_CLAW_VOICE_V01.recorder'); globals().update({k: getattr(_mod, k) for k in ['check_recording_availability']})
...
class TestVoiceInit:
    def test_check_voice_deps_returns_tuple(self):
        import importlib; _mod = importlib.import_module('2024-06-19_CLAW_VOICE_V01'); globals().update({k: getattr(_mod, k) for k in ['check_voice_deps']})
        result = check_voice_deps()
        assert isinstance(result, tuple)
        assert len(result) == 2

    def test_exports(self):
        import importlib; globals()['voice'] = importlib.import_module('2024-06-19_CLAW_VOICE_V01')
