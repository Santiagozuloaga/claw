...
globals().update({'ToolDef': getattr(m_2024_06_19_CLAW_TOOL_REGISTRY_V01, 'ToolDef'), 'clear_registry': getattr(m_2024_06_19_CLAW_TOOL_REGISTRY_V01, 'clear_registry'), 'execute_tool': getattr(m_2024_06_19_CLAW_TOOL_REGISTRY_V01, 'execute_tool'), 'get_all_tools': getattr(m_2024_06_19_CLAW_TOOL_REGISTRY_V01, 'get_all_tools'), 'get_tool': getattr(m_2024_06_19_CLAW_TOOL_REGISTRY_V01, 'get_tool'), 'get_tool_schemas': getattr(m_2024_06_19_CLAW_TOOL_REGISTRY_V01, 'get_tool_schemas'), 'register_tool': getattr(m_2024_06_19_CLAW_TOOL_REGISTRY_V01, 'register_tool')})
