...
from CLAW_2026_06_24_MULTI_AGENT_V01.subagent import SubAgentManager, SubAgentTask, _extract_final_text
...
def manager(monkeypatch):
    ...
    monkeypatch.setattr("CLAW_2026_06_24_MULTI_AGENT_V01.subagent._agent_run", mock)
