...
class TestSplitIdentifier:
    def test_camel_case(self):
        from CLAW_2026_06_24_VOICE_V01.keyterms import split_identifier
...
class TestGetVoiceKeyterms:
    def test_returns_list(self):
        from CLAW_2026_06_24_VOICE_V01.keyterms import get_voice_keyterms
        terms = get_voice_keyterms()
        assert isinstance(terms, list)

    def test_global_terms_present(self):
        from CLAW_2026_06_24_VOICE_V01.keyterms import get_voice_keyterms, GLOBAL_KEYTERMS
        terms = get_voice_keyterms()
    ...
    def test_max_length(self):
        from CLAW_2026_06_24_VOICE_V01.keyterms import get_voice_keyterms, MAX_KEYTERMS
        terms = get_voice_keyterms()
...
class TestPcmToWav:
    def test_riff_header(self):
        from CLAW_2026_06_24_VOICE_V01.stt import _pcm_to_wav
...
class TestKeytermsToPrompt:
    def test_empty(self):
        from CLAW_2026_06_24_VOICE_V01.stt import _keyterms_to_prompt
...
class TestSttAvailability:
    def test_returns_tuple(self):
        from CLAW_2026_06_24_VOICE_V01.stt import check_stt_availability
...
class TestRecorderAvailability:
    def test_returns_tuple(self):
        from CLAW_2026_06_24_VOICE_V01.recorder import check_recording_availability
...
class TestVoiceInit:
    def test_check_voice_deps_returns_tuple(self):
        from CLAW_2026_06_24_VOICE_V01 import check_voice_deps
        result = check_voice_deps()
        assert isinstance(result, tuple)
        assert len(result) == 2

    def test_exports(self):
        import CLAW_2026_06_24_VOICE_V01 as voice
...
class TestReplVoiceIntegration:
    def test_voice_in_commands(self):
        import CLAW_2026_06_24_CLAWSPRING_CORE_V01 as clawspring
